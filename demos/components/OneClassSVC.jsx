    ...
    <FormProvider {...methods}>
      ...
      <div className="d-flex flex-wrap mt-4 mb-4">
        <div className="col-lg-7 col-xl-7 col-md-12">
          ...
          <ControlBar
            style={{ paddingLeft: 4 }}
            helpTitle="One-class support vector classification canvas"
            help="Each sample is a 2-dimensional data point [x, y] that is represented by a circle. All samples are used to train the SVM classifier. A circle with a thick border means it is a support vector. The color of each pixel in the background represents the decision of the classifier at the pixel's coordinates: red if it is within, blue if it is outside the training set."
